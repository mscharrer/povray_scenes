...
// background motionblurred debris
plane {
	z
	10
	hollow
...
#while(i < 2000)
	sphere {
		...
		scale .7
		translate (150 + 100*rand(s)) * z
		translate 1300*<.5-rand(s), .5-rand(s), 0>
	}
	#declare i = i + 1;
#end
